...
function App() {
  ...
  return (
    <div className='card'>
      ...
      <div className='grid'>
        {arr.map((hero, index) => (
          <img src={hero} alt="asd" key={index} className={`fade ${fade}`} onClick={e => handleClick(e)} />
        ))}
      </div>
    </div>
  )
